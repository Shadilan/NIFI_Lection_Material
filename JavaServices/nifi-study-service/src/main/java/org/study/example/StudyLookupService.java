...
public class StudyLookupService extends AbstractControllerService implements StringLookupService {
    ...
    public Optional<String> lookup(Map<String, Object> coordinates){
        //Описываем как из координат находим значение

        //Если не нашли возвращаем пустое значение
        return Optional.empty();
    }

    @Override
    public Set<String> getRequiredKeys() {
        //Список ключей которые должны быть в координатах
        return null;
    }
}
